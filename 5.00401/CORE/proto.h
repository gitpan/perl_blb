...
OP*	doeval _((int gimme, OP** startp));
...
I32	pregexec _((regexp* prog, char* stringarg, char* strend, char* strbeg, I32 minend, SV* screamer, void* data, U32 flags));
void	pregfree _((struct regexp* r));
regnode*regnext _((regnode* p));
void	regprop _((SV* sv, regnode* op));
